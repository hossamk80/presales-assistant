...
1. **التحليل والمخاطر** — رفع الكراسة (PDF/Word/Excel/CSV/HTML، مع OCR للممسوح
   ضوئياً)، ثم Go/No-Go ومصفوفة الأوزان والشروط الحاكمة.
2. **الامتثال وجدول الكميات** — استخراج آلي مُهيكل للمتطلبات وبنود BOQ من
   الكراسة إلى جداول قابلة للتحرير. حالة الالتزام تبقى قراراً بشرياً ولا
   يفترضها النموذج.
