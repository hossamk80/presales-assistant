...
PERMISSIONS: dict[str, tuple] = {
    ...
    # ب-6: دفع أمر البيع إلى نظام العميل المحاسبي. **أضيق من كل ما سبق**:
    # الوحيد في النظام الذي يكتب في دفاتر جهةٍ أخرى، وخطؤه لا يُتراجَع عنه
    # من هنا. ومنشأة تريده لمدير عطاءاتها تمنحه من شاشة الصلاحيات.
    "connector.push": (ADMIN,),
    ...
    # فمرحلتها لمن يملك المنافسة؛ والفصل بين المُعتمِدين يظهر في السجل ولا
    # يُفرَض — قسم من شخصين لا يجوز أن يُمنع من التسليم.
    "approve.bid_manager": (ADMIN, BID_MANAGER),
    "approve.finance": (ADMIN, BID_MANAGER),
    # الاعتماد النهائي وحده محصور بمدير النظام
    "approve.final": (ADMIN,),
